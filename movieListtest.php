        ...
        <div id="bigRect" class="tile tile-super-x tile-large-y fixBigRect">
            <div class="tile-content">
                ...
                <span class="tile-label tileLabelFixed_L">Despicable Me 2</span>
				             ...
				             <!--move3inf><!-->
      <div id="Despicable Me 2" class="movie-info-text" class="tile tile-large-x">
                                	<b><h1>Story</h1></b>
										<br/>
                                     <div class="each-col f-right">
                                                                         	<div class="each-row">
        ...
        <div id="bigRect" class="tile tile-super-x tile-large-y fixBigRect">
            <div class="tile-content">
                ...
                <span class="tile-label tileLabelFixed_L">Blood Diamond</span>
				             ...
				             <!--move4inf><!-->
      <div id="Blood Diamond" class="movie-info-text" class="tile tile-large-x">
                                	<b><h1>Story</h1></b>
										<br/>
                                     <div class="each-col f-right">
                                                                         	<div class="each-row">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-onlineBuy">
              ...
              <div class="select-etix-cont" id="div-select-etix-cont">
				...
				<form name='book' action='cart-page.php' method='post'>
					...
					<select name='moviename' id ='movie'  required='required' onchange="everything()" >
						...
						<option value='AC' id='AC'>The Bourne Legacy</option>
					</select>
					</div>
				    </div>
           			<div class="clearboth"></div>
				...
				<!--Select Head  ↑ ↑><!-->
					...
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='movieday' id='day' required='required' onchange="everything()">
				...
				<!--Select day  ↑ ↑><!-->
					...
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='movietime' id='time' required='required' onchange="everything()" >
				...
				<!--Select time  ↑ ↑><!-->
					...
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='samovieseat' id='SA' required='required' onchange="everything()">
				...
				<!--Select Adult  ↑ ↑><!-->
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='spmovieseat' id='SP'required='required' onchange="everything()">
						<option value='0' selected='selected'>0</option>
						<option value='1'>1</option>
						<option value='2'>2</option>
						<option value='3'>3</option>
				...
				<!--Select Concession  ↑ ↑><!-->
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='scmovieseat' id='SC' required='required' onchange="everything()">
						<option value='0' selected='selected'>0</option>
						<option value='1'>1</option>
						<option value='2'>2</option>
						<option value='3'>3</option>
				...
				<!--Select Child  ↑ ↑><!-->
					...
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='famovieseat' id='FA' required='required' onchange="everything()">
						<option value='0' selected='selected'>0</option>
						<option value='1'>1</option>
						<option value='2'>2</option>
						<option value='3'>3</option>
				...
				<!--Select FCA  ↑ ↑><!-->
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='fcmovieseat' id='FC' required='required' onchange="everything()">
						<option value='0' selected='selected'>0</option>
						<option value='1'>1</option>
						<option value='2'>2</option>
						<option value='3'>3</option>
				...
				<!--Select FCC  ↑ ↑><!-->
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='b1movieseat' id='B1' required='required' onchange="everything()">
						<option value='0' selected='selected'>0</option>
						<option value='1'>1</option>
						<option value='2'>2</option>
						<option value='3'>3</option>
				...
				<!--Select B1P  ↑ ↑><!-->
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='b2movieseat' id='B2' required='required' onchange="everything()">
						<option value='0' selected='selected'>0</option>
						<option value='1'>1</option>
						<option value='2'>2</option>
						<option value='3'>3</option>
				...
				<!--Select B2P  ↑ ↑><!-->
					<div class="each-row ticket-row">
						...
						<div class="col-2" style="width:190px">
							<div class="selectWrap172">
					<select name='b3movieseat' id='B3' data-style="btn-primary" required='required' onchange="everything()">
						<option value='0' selected='selected'>0</option>
						<option value='1'>1</option>
						<option value='2'>2</option>
						<option value='3'>3</option>
